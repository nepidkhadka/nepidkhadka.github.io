    ...
    <div className="h-[100dvh] max-h-[900px] flex flex-col items-center justify-center text-center space-y-4 md:space-y-6">
      ...
      >
        <Image
          ...
          height={200}
          priority
          className="h-48 w-48 xl:h-64 xl:w-64 2xl:h-80 2xl:w-80 rounded-full object-contain"
        />
      </motion.div>
      ...
      <div className="space-y-4 overflow-hidden">
        ...
        >
          {["D", "I", "P", "E", "N", "K", "H", "A", "D", "K", "A"].map(
            (letter, index) => (
              <motion.span
                key={index}
                className={`inline-block ${index == 5 && "ml-4"}`}
      ...
      >
        <Link
          className="border-2 rounded-full p-2 text-muted-foreground hover:border-primary/50 transition-all"
          href="https://github.com/nepidkhadka"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Github className="text-2xl transition-all" />
        </Link>
        <Link
          className="border-2 rounded-full p-2 text-muted-foreground hover:border-primary/50 transition-all"
          ...
          rel="noopener noreferrer"
        >
          <Linkedin className="text-2xl transition-all" />
        </Link>
        <Link
          className="border-2 rounded-full p-2 text-muted-foreground hover:border-primary/50 transition-all"
          ...
          rel="noopener noreferrer"
        >
          <Facebook className="text-2xl transition-all" />
        </Link>
      </motion.div>
    </div>
  );
