...
export const metadata: Metadata = {
    ...
    title: "About Me | Dipen Khadka - Full-Stack Developer",
    description: "A passionate Full-Stack Developer from Nepal, dedicated to crafting modern, scalable web applications. I enjoy designing and developing intuitive user-friendly applications. Open to collaborations, freelance projects, and opportunities!",
    keywords:
