...
export const metadata: Metadata = {
    ...
    title: "Contact | Dipen Khadka - Full-Stack Developer",
    description: "Get in touch with me for collaborations, freelance projects, or any queries. I am always open to new opportunities and challenges. Feel free to reach out to me via email or the contact form below.",
    keywords:
